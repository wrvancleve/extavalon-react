...
export default function Help({settings}) {
    return (
        <div className="CenterFlexColumn" id="LobbyContent">
            ...
            <ul>
                <li>
                    <span className="Resistance">Merlin</span>: Sees <span className="Spy">spies</span> (except <span className="Spy">Mordred</span>) and
                    <span className="Resistance">Puck</span>; Can be assassinated
                </li>
                <li>
                    <span className="Resistance">Arthur</span>: Sees <span className="Resistance">resistance</span> roles present; Can be assassinated
                </li>
                <li>
                    <span className="Resistance">Tristan</span>: Sees <span className="Resistance">Iseult</span>; Can be
                    assassinated with <span className="Resistance">Iseult</span>
                </li>
                <li>
                    <span className="Resistance">Iseult</span>: Sees <span className="Resistance">Tristan</span>; Can be
                    assassinated with <span className="Resistance">Tristan</span>
                </li>
                {settings.ector &&
                    <li>
                        (8+) <span className="Resistance">Ector</span>: Known by all <span className="Resistance">Resistance</span> members; Can be
                        assassinated
                    </li>

                }
                <li>
                    <span className="Resistance">Percival</span>: Sees <span className="Resistance">Merlin</span> and
                    <span className="Spy">Morgana</span>
                </li>
                <li>
                ...
                <li>
                    (7+) <span className="Resistance">Guinevere</span>: Sees <span className="Resistance">Lancelot</span> and
                    <span className="Spy">Maelagant</span>
                </li>
                <li>
                ...
                {settings.kay &&
                    <li>
                        (8+) <span className="Resistance">Kay</span>: If <span className="Spy">Spies</span> win 3 rounds, can redeem <span className="Resistance">Resistance</span>
                        by naming all <span className="Spy">Spies</span> correctly
                    </li>
                }
                {settings.lamorak &&
                    <li>
                ...
                {settings.sirrobin &&
                    settings.accolon
                        ?
                            <li>
                                (9+) <span className="Resistance">Sir Robin</span>: While conducting a mission, discovers a new <span className="Resistance">Resistance</span> member also on
                                that mission; Blocked when <span className="Spy">Accolon</span> is on the same mission
                            </li>
                        :
                            <li>
                                (9+) <span className="Resistance">Sir Robin</span>: While conducting a mission, discovers a new <span className="Resistance">Resistance</span> member also on
            ...
            <ul>
                ...
                {settings.gaheris
                    ?
                        <li>
                            <span className="Spy">Morgana</span>: Seen as possible <span className="Resistance">Merlin</span>
                            by <span className="Resistance">Percival</span>; Immunue to <span className="Resistance">resistance</span> binds
                        </li>
                    :
                        <li>
                            <span className="Spy">Morgana</span>: Seen as possible <span className="Resistance">Merlin</span>
                            by <span className="Resistance">Percival</span>
                        </li>
                }
                <li>
                ...
                {settings.accolon &&
                    settings.sirrobin
                        ?
                            <li>
                                (7+) <span className="Spy">Accolon</span>: Sabotages the vision of a random <span className="Resistance">resistance</span> player; Blocks
                                <span className="Resistance">Sir Robin</span>'s ability if on that mission
                            </li>
                        :
                            <li>
