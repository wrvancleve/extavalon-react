...
import FutureSettingRow from '../../components/futureSettingRow/FutureSettingRow';
...
export default function Home() {
    ...
    const [currenMenuName, setCurrentMenuName] = useState("");
    ...
    function handleJoinGameSubmit(e) {
        e.preventDefault();
        navigate("/game", { state: {code: enteredGameCode, isHost: false} });
    }
    ...
    function handleCreateLocalGameSubmit(e) {
        ...
        axios.request({
            ...
            if (response.data.code) {
                navigate("/game", { state: {code: response.data.code, isHost: true} });
            }
        });
    }
